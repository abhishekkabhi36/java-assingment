...
// - Name: FactorialCalculatorDemo
// - Choose Apache Tomcat as target runtime
//
// Step 2: Create the Servlet
// - Right-click src → New → Class
// - Name: FactorialServlet
//
// Step 3: Create HTML file (index.html) in WebContent folder
//
// Step 4: Run the application on server and test factorial calculation
